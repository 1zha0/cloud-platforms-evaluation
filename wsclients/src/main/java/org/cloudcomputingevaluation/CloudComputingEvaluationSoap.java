...
public interface CloudComputingEvaluationSoap {
    ...
    @WebMethod(action = "http://cloudComputingEvaluation.org/cleanDefaultData")
    public boolean cleanDefaultData(
    ...
    @WebMethod(action = "http://cloudComputingEvaluation.org/setupDefaultData")
    public int setupDefaultData(
        @WebParam(name = "numberOfEntries", targetNamespace = "http://cloudComputingEvaluation.org/")
        int numberOfEntries,
        @WebParam(name = "offset", targetNamespace = "http://cloudComputingEvaluation.org/")
        int offset
