...
@WebServiceClient(name = "CloudComputingEvaluation", 
                  wsdlLocation = "file:/tmp_amd/adams/import/1/xmwu432/project/src/main/resources/CloudComputingEva.wsdl",
...
public class CloudComputingEvaluation extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("file:/tmp_amd/adams/import/1/xmwu432/project/src/main/resources/CloudComputingEva.wsdl");
        } catch (MalformedURLException e) {
            System.err.println("Can not initialize the default wsdl from file:/tmp_amd/adams/import/1/xmwu432/project/src/main/resources/CloudComputingEva.wsdl");
            // e.printStackTrace();
        }
        WSDL_LOCATION = url;
    }
