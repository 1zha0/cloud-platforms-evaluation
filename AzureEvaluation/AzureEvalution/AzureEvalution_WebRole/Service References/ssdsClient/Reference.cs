...
namespace AzureEvalution_WebRole.ssdsClient {
    ...
    public partial struct Scope : System.Runtime.Serialization.IExtensibleDataObject, System.ComponentModel.INotifyPropertyChanged {
        ...
        [System.Runtime.Serialization.OptionalFieldAttribute()]
        private AzureEvalution_WebRole.ssdsClient.VersionMatch VersionMatchField;
        ...
        public AzureEvalution_WebRole.ssdsClient.VersionMatch VersionMatch {
            get {
    ...
    public partial class VersionMatch : object, System.Runtime.Serialization.IExtensibleDataObject, System.ComponentModel.INotifyPropertyChanged {
        ...
        [System.Runtime.Serialization.OptionalFieldAttribute()]
        private AzureEvalution_WebRole.ssdsClient.VersionMatchType MatchTypeField;
        ...
        [System.Runtime.Serialization.DataMemberAttribute()]
        public AzureEvalution_WebRole.ssdsClient.VersionMatchType MatchType {
            get {
    ...
    [System.SerializableAttribute()]
    [System.Runtime.Serialization.KnownTypeAttribute(typeof(AzureEvalution_WebRole.ssdsClient.Authority))]
    [System.Runtime.Serialization.KnownTypeAttribute(typeof(AzureEvalution_WebRole.ssdsClient.Container))]
    ...
    [System.SerializableAttribute()]
    public partial class Authority : AzureEvalution_WebRole.ssdsClient.Entity {
    }
    ...
    [System.SerializableAttribute()]
    public partial class Container : AzureEvalution_WebRole.ssdsClient.Entity {
    }
    ...
    public partial class Error : object, System.Runtime.Serialization.IExtensibleDataObject, System.ComponentModel.INotifyPropertyChanged {
        ...
        [System.Runtime.Serialization.OptionalFieldAttribute()]
        private AzureEvalution_WebRole.ssdsClient.ErrorCodes StatusCodeField;
        ...
        [System.Runtime.Serialization.DataMemberAttribute()]
        public AzureEvalution_WebRole.ssdsClient.ErrorCodes StatusCode {
            get {
    ...
    [System.ServiceModel.ServiceContractAttribute(Namespace="http://schemas.microsoft.com/sitka/2008/03/", ConfigurationName="ssdsClient.ISitkaSoapService")]
    public interface ISitkaSoapService {
        ...
        [System.ServiceModel.FaultContractAttribute(typeof(AzureEvalution_WebRole.ssdsClient.Error), Action="http://schemas.microsoft.com/sitka/2008/03/ISitkaSoapService/CreateErrorFault", Name="Error")]
        AzureEvalution_WebRole.ssdsClient.Scope Create(AzureEvalution_WebRole.ssdsClient.Scope scope, AzureEvalution_WebRole.ssdsClient.Entity entity);
        ...
        [System.ServiceModel.FaultContractAttribute(typeof(AzureEvalution_WebRole.ssdsClient.Error), Action="http://schemas.microsoft.com/sitka/2008/03/ISitkaSoapService/GetErrorFault", Name="Error")]
        AzureEvalution_WebRole.ssdsClient.Entity Get(AzureEvalution_WebRole.ssdsClient.Scope scope);
        ...
        [System.ServiceModel.FaultContractAttribute(typeof(AzureEvalution_WebRole.ssdsClient.Error), Action="http://schemas.microsoft.com/sitka/2008/03/ISitkaSoapService/UpdateErrorFault", Name="Error")]
        AzureEvalution_WebRole.ssdsClient.Scope Update(AzureEvalution_WebRole.ssdsClient.Scope scope, AzureEvalution_WebRole.ssdsClient.Entity entity);
        ...
        [System.ServiceModel.FaultContractAttribute(typeof(AzureEvalution_WebRole.ssdsClient.Error), Action="http://schemas.microsoft.com/sitka/2008/03/ISitkaSoapService/DeleteErrorFault", Name="Error")]
        void Delete(AzureEvalution_WebRole.ssdsClient.Scope scope);
        ...
        [System.ServiceModel.FaultContractAttribute(typeof(AzureEvalution_WebRole.ssdsClient.Error), Action="http://schemas.microsoft.com/sitka/2008/03/ISitkaSoapService/QueryErrorFault", Name="Error")]
        System.Collections.Generic.List<AzureEvalution_WebRole.ssdsClient.Entity> Query(AzureEvalution_WebRole.ssdsClient.Scope scope, [System.ServiceModel.MessageParameterAttribute(Name="query")] string query1);
    }
    
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "3.0.0.0")]
    public interface ISitkaSoapServiceChannel : AzureEvalution_WebRole.ssdsClient.ISitkaSoapService, System.ServiceModel.IClientChannel {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "3.0.0.0")]
    public partial class SitkaSoapServiceClient : System.ServiceModel.ClientBase<AzureEvalution_WebRole.ssdsClient.ISitkaSoapService>, AzureEvalution_WebRole.ssdsClient.ISitkaSoapService {
        ...
        public AzureEvalution_WebRole.ssdsClient.Scope Create(AzureEvalution_WebRole.ssdsClient.Scope scope, AzureEvalution_WebRole.ssdsClient.Entity entity) {
            return base.Channel.Create(scope, entity);
        }
        
        public AzureEvalution_WebRole.ssdsClient.Entity Get(AzureEvalution_WebRole.ssdsClient.Scope scope) {
            return base.Channel.Get(scope);
        }
        
        public AzureEvalution_WebRole.ssdsClient.Scope Update(AzureEvalution_WebRole.ssdsClient.Scope scope, AzureEvalution_WebRole.ssdsClient.Entity entity) {
            return base.Channel.Update(scope, entity);
        }
        
        public void Delete(AzureEvalution_WebRole.ssdsClient.Scope scope) {
            base.Channel.Delete(scope);
        }
        
        public System.Collections.Generic.List<AzureEvalution_WebRole.ssdsClient.Entity> Query(AzureEvalution_WebRole.ssdsClient.Scope scope, string query1) {
