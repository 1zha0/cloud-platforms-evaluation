...
cp candidates/one_round_Create_test/BinaryFileWriteTests-AzureStorage.java src/main/java/org/unsw/eva/strategy/ThreadBaseStrategyTest.java 
cp candidates/one_round_Create_test/App.java src/main/java/org/unsw/eva/wsclient/App.java
