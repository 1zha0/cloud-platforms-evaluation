...
public class ThreadBaseStrategyTest extends AbstractStrageyTest {
     ...
     */
    private static int REPEAT_RUNNING_NUMBER_OF_TIMES = 300;
...
//        testSuit.add(new InstanceResponeTests("AmazonInstanceResponse", this, ServerType.AMAZONE, NUMBER_OF_REQUESTS_SEND_WITHIN_ONE_THREAD));
        testSuit.add(new CreateTests("AmazonCreateSimpleDB_"+ResourceUtil.getSendString().length(), this, ServerType.AMAZONE_SIMPLEDB, NUMBER_OF_REQUESTS_SEND_WITHIN_ONE_THREAD));
